...
env.project_root = '/home/vim_guide_survivor/vim_guide_survivor'
env.app_root = os.path.join(env.project_root, 'vim_guide_survivor')
env.virtualenv = '/home/vim_guide_survivor/env'
